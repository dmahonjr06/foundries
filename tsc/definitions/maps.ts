export const bucketMap: ReadonlySet<string> = new Set<string>([
...
export const playerInputItemsIntoFoundry: ReadonlyMap<string, { materialNumber: number, layersToFill: number }> = new Map([
